...
function UserProfileHeader({ currentUser, isUploading, uploadError, handleImageUpload }) {
    ...
    <section className="mt-4 mb-4 flex w-80 items-center gap-4">
      <div className="group avatar relative">
        <div className="ring-primary ring-offset-base-100 h-16 w-16 overflow-hidden rounded-full ring-3 ring-offset-2">
          <img
            src={currentUser?.profileImage || "/assets/moonProfile.webp"}
            alt="Avatar"
      ...
      <div className="">
        <h1 className="text-2xl font-bold">{t("userPage.title")}</h1>
        <h2 className="text-sm">{t("userPage.profileDescription")}</h2>
